...
//-----------------------------------------------------------------------------------------------------
class CPss21// : public CDevice//, public CDfa
{
public:
    enum
    {
...
//    virtual ~CPss21();
    ...
    static uint8_t CreateConfiguration(uint8_t * );
    static uint8_t InitDevices(uint8_t * );
...
//    static void DiscreteOutputsSet(uint8_t uiLinkedDiscreteOutputs, uint8_t uiNewViolation);
...
//    static CDevice* m_apxDevices[INTERNAL_MODULE_QUANTITY];
...
//    static CTimer m_xPeripheryTimer;
...
public:
//    static CDataBase m_xDataBase;
//    static CDataBase* m_pxDataBase;
